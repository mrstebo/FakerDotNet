...
namespace FakerDotNet.Tests
{
    ...
    public class FakerContainerTests
    {
        ...
        {
            Assert.IsInstanceOf<IBankFaker>(_fakerContainer.Bank);
        }
        ...
        {
            Assert.IsInstanceOf<ICompassFaker>(_fakerContainer.Compass);
        }
        ...
        [Test]
        public void Hipster_returns_IHipsterFaker()
        {
            Assert.IsInstanceOf<IHipsterFaker>(_fakerContainer.Hipster);
        }
