...
{
    internal static class FoodData
    {
        public static readonly IEnumerable<string> Dishes = new[]
        {
            "Arepas",
            "Barbecue Ribs",
        ...
        public static readonly IEnumerable<string> Descriptions = new[]
        {
        ...
        public static readonly IEnumerable<string> Ingredients = new[]
        {
            "Achacha",
            "Adzuki Beans",
            "Agar",
        ...
        public static readonly IEnumerable<string> Fruits = new[]
        {
            "Apples",
            "Apricots",
            "Aubergine",
        ...
        public static readonly IEnumerable<string> Vegetables = new[]
        {
            "Artichoke",
            "Arugula",
            "Asian Greens",
        ...
        public static readonly IEnumerable<string> Spices = new[]
        {
            "Achiote Seed",
            "Ajwain Seed",
            "Ajwan Seed",
        ...
        public static readonly IEnumerable<string> Measurements = new[]
        {
            "teaspoon",
            "tablespoon",
            "cup",
        ...
        public static readonly IEnumerable<string> MeasurementSizes = new[]
        {
            "1/4",
            "1/3",
            "1/2",
        ...
        public static readonly IEnumerable<string> MetricMeasurements = new[]
        {
            "milliliter",
            "deciliter",
            "centiliter",
        ...
        public static readonly IEnumerable<string> Sushi = new[]
        {
            "Abalone",
            "Alaskan pink shrimp",
            "Amberjack",
